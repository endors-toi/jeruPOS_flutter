...
class _PedidoTileState extends State<PedidoTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(color: Color.fromARGB(255, 255, 222, 171), width: 1),
              ...
              : usuario!.rol != 4
                  ? Expanded(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          widget.pedido.estado = "PAGADO";
                          await PedidoService.updatePATCH(widget.pedido);
                          widget.onAction();
                        },
                      ),
                    )
  ...
  num calcularTotal() {
    num total = 0;
    List<ProductoPedido> productos = widget.pedido.productos!;
